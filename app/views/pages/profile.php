      ...
      <!-- Left Panel
        ...
        <aside class="col-lg-3"> 
          ...
          <div class="bg-white shadow-sm rounded text-center p-3 mb-4">
            <div class="profile-thumb mt-3 mb-4"> <img class="rounded-circle" src="<?=URLROOT?>/assets/images/profile-thumb.jpg" alt="">
        ...
        <div class="col-lg-9"> 
          ...
          <div class="bg-white shadow-sm rounded p-4 mb-4">
            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Username: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->fullname?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Account No: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->accountno?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Account type: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->type?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Login ID: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->accountid?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Password: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2">******** </span> &nbsp;
            <a href="<?=URLROOT?>/users/update/<?= $data['user']->id ?>" class="text-1">Change password</a> </h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Email: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->email?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">country: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->country?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Mobile: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->mobile?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Address: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->address?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Occupation: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->occupation?></span></h3>
            <hr class="mb-4 mx-n4">

            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Date of Birth: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->dob?></span></h3>
            <hr class="mb-4 mx-n4">
            
            <h3 class="text-3 fw-400 d-flex align-items-center mb-4">Gender: <span class="border text-success rounded-pill fw-500 text-2 px-3 py-1 ms-2"><?=$data['user']->gender?></span></h3>
            <hr class="mb-4 mx-n4">
